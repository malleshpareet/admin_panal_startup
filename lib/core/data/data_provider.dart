    ...
    try {
      ...
      if (response.isOk) {
        ...
        _filteredCategories = List.from(
            _allCategories); // Initialized Filtered List with all data
        notifyListeners();
    ...
    try {
      ...
      if (response.isOk) {
        ...
        _filteredSubCategories = List.from(
            _allSubCategories); // Initialized Filtered List with all data
        notifyListeners();
        if (showSnack) SnackBarHelper.showSuccessSnackBar(apiResponse.message);
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.isOk) {
        ...
        _filteredBrands = List.from(
            _allBrands); // Initialized Filtered List with all data
        notifyListeners();
        if (showSnack) SnackBarHelper.showSuccessSnackBar(apiResponse.message);
      }
    } catch (e) {
...
void filterBrand(String keyword){
  if (keyword.isEmpty) {
    ...
    try {
      ...
      if (response.isOk) {
        ...
        _filteredVariantTypes = List.from(
            _allVariantTypes); // Initialized Filtered List with all data
        notifyListeners();
        if (showSnack) SnackBarHelper.showSuccessSnackBar(apiResponse.message);
    ...
    try {
      ...
      if (response.isOk) {
        ...
        _filteredVariants = List.from(
            _allVariants); // Initialized Filtered List with all data
        notifyListeners();
        if (showSnack) SnackBarHelper.showSuccessSnackBar(apiResponse.message);
